...
export async function createClass(payload) {
    const insertResult = await db.query(`INSERT INTO class (id_professor, name_class, id_subject, id_section, fecha, ai_summary, current_questions_summary, score_average)
     VALUES (?, ?, ?, ?, ?, ?, ?, ?)`, [
        payload.professorId,
        payload.name,
        payload.subjectId,
    ...
    const created = await db.query(`SELECT id_class, id_professor, name_class, id_subject, id_section, fecha, ai_summary, current_questions_summary, score_average
     FROM class
...
export async function enrollStudentsInClass(classId, students) {
    ...
    try {
        ...
        for (const student of students) {
            await client.query(`INSERT INTO class_student (id_class, id_user, ai_summary, interaction_coefficient, score_average)
         VALUES (?, ?, ?, ?, ?)
