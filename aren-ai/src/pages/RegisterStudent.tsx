            ...
            <IonRow class="ion-justify-content-center">
              <IonCol size="12" size-md="8" size-lg="6" size-xl="4">
                ...
                <div className="brand-section">
                  ...
                  <IonText>
                    <p className="brand-subtitle">Quick registration for students</p>
                  </IonText>
                </div>
                  ...
                  <IonCardContent>
                    <form onSubmit={handleRegister}>
                      ...
                      <div className="input-section">
                        <IonText><h3 className="input-label">Username</h3></IonText>
                      ...
                      {/* Password */}
                      <div className="input-section">
                        <IonText><h3 className="input-label">Password</h3></IonText>
                        <IonItem className="input-item" lines="none">
                      ...
                      {/* Confirm Password */}
                      <div className="input-section">
                        <IonText><h3 className="input-label">Confirm Password</h3></IonText>
                        <IonItem className="input-item" lines="none">
                          <IonIcon icon={key} slot="start" className="input-icon" />
                          <IonInput
                      ...
                      {/* Institution */}
                      <div className="input-section">
                        <IonText><h3 className="input-label">Institution</h3></IonText>
                        <IonItem className="input-item" lines="none">
                          <IonIcon icon={business} slot="start" className="input-icon" />
                          <IonInput
                            type="text"
                            placeholder="Enter institution name"
                            value={formData.institution}
                            onIonInput={(e) => handleInputChange('institution', e.detail.value!)}
                            className="custom-input"
                            required
                          />
                        </IonItem>
                      ...
                      {/* Section ID */}
                      <div className="input-section">
                        <IonText><h3 className="input-label">Section ID</h3></IonText>
                        <IonItem className="input-item" lines="none">
                          <IonInput
                            type="number"
                            placeholder="Enter section id (from QR or teacher)"
                            value={formData.sectionId}
                            onIonInput={(e) => handleInputChange('sectionId', String(e.detail.value))}
                            className="custom-input"
                            required
                          />
                        </IonItem>
