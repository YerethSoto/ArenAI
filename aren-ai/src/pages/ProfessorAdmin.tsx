...
import { saveOutline, checkmarkCircle } from "ionicons/icons";
...
const ProfessorAdmin: React.FC = () => {
  ...
  return (
    <IonPage>
      <StudentHeader
        pageTitle="professor.admin.title"
        showSubject={true}
        selectedSubject={`${selectedSubject} - Grade ${selectedGrade} - Section ${selectedSection}`}
        ...
        <div className="admin-container">
          <div className="admin-header-section">
            ...
            <p className="admin-subtitle">
              {selectedSubject} • Grade {selectedGrade} • Section{" "}
              {selectedSection}
            </p>
          </div>
                ...
                <div className="admin-card-content">
                  <div className="student-admin-header">
                    ...
                    <div className="admin-student-info">
                      ...
                      <span className="admin-student-id">
                  ...
                  <div className="admin-controls">
                      ...
                      <div className="attendance-toggles">
                        <button
                          className={`attendance-btn present ${
                            student.attendance === "present" ? "active" : ""
                          }`}
                          onClick={() =>
                        ...
                        <button
                          className={`attendance-btn late ${
                            student.attendance === "late" ? "active" : ""
                          }`}
                          onClick={() =>
                        ...
                        <button
                          className={`attendance-btn absent ${
                            student.attendance === "absent" ? "active" : ""
                          }`}
                          onClick={() =>
                    ...
                    <div className="control-group">
                      ...
                      <div className="grade-input-container">
                        ...
                        />
                        <span
                          className={`grade-badge ${getScoreColor(
                            student.score
                          )}`}
                        >
                          {student.score >= 85
