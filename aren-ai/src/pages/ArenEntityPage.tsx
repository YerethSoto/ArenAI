...
const ENTITY_DATA = [
    {
        ...
        sprite: "/assets/battle_sprite_front_capybara.png",
    ...
    },
    {
        ...
        sprite: "/assets/profile_picture_sloth_eyes_open.png",
...
const ArenEntityPage: React.FC = () => {
    ...
    const currentEntity = ENTITY_DATA.find(e => e.id === selectedId) || ENTITY_DATA[0];
        ...
        <IonPage className="ae-page">
                    ...
                    <div className="ae-main-split">
                        ...
                        <div className="ae-lore-container">
                            ...
                            <div className="ae-text-scroll">
                                <p className="ae-lore-text">
                                    "{t(`arenEntity.lore.${currentEntity.id}`, { name: customName || t(`arenEntity.names.${currentEntity.id}`) })}"
                                </p>
                                <div className="ae-simple-stats">
                                    <div className="ae-stat-card">
                                        ...
                                        <div className="ae-stat-info">
                                            <span className="ae-stat-label">{t('arenEntity.battlesWon')}</span>
                                            <span className="ae-stat-value success">{currentEntity.stats.wins}</span>
                                        </div>
                                    </div>
                                    ...
                                    <div className="ae-stat-card">
                                        ...
                                        <div className="ae-stat-info">
                                            <span className="ae-stat-label">{t('arenEntity.timesSummoned')}</span>
                                            <span className="ae-stat-value">{currentEntity.stats.usage}</span>
                                        </div>
                                    </div>
                                    ...
                                    <div className="ae-stat-card">
                                        ...
                                        <div className="ae-stat-info">
                                            <span className="ae-stat-label">{t('arenEntity.firstEncounter')}</span>
                                            <span className="ae-stat-value small">{currentEntity.stats.firstSeend}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="ae-sprite-container">
                            ...
                            <div className={`ae-friendship-badge ${hideUI ? 'hidden' : ''}`}>
                                <span className="ae-friendship-label">{t('arenEntity.friendship')}</span>
                                <span className="ae-friendship-value">Lv. {currentEntity.stats.lvl}</span>
                            </div>
            ...
            <div className={`ae-duel-selector-container ${hideUI ? 'hidden' : ''}`}>
                <div className="ae-carousel-arc">
                    ...
                    {[...ENTITY_DATA, { id: 'locked1' }, { id: 'locked2' }, { id: 'locked3' }].map((item, index) => {
                        // Calculate offset from current selection
                        // We map real entities to their actual index, locked ones follow
                        const dataIndex = index;
                        const activeIndex = [...ENTITY_DATA, { id: 'locked1' }, { id: 'locked2' }, { id: 'locked3' }].findIndex(i => i.id === selectedId);
