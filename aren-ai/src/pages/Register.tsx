                      ...
                      <div className="input-section">
                        <IonText>
                          <h3 className="input-label">
                            ...
                            {showMEPSelector && (
                              <span className="mep-selector-badge">Select from MEP</span>
                            )}
                          </h3>
                        </IonText>
                        ...
                        {showMEPSelector ? (
                              ...
                              <div className="mep-selector-dropdown">
                                ...
                                <div className="institution-list">
                                  {filteredInstitutions.slice(0, 10).map((institution, index) => (
                                    ...
                                    >
                                      <IonIcon icon={school} slot="start" className="institution-icon" />
                                      <IonText>
                          ...
                          <IonItem className="input-item" lines="none">
                            ...
                            <IonInput
                              ...
                              onIonInput={(e) => !isInstitutionLocked && handleInputChange('institution', e.detail.value!)}
                              className="custom-input"
                              required
                        ...
                        {isInstitutionLocked && (
                          <IonText>
                            <p className="institution-hint">
                              Institution automatically detected from email domain
                            </p>
                          </IonText>
                        )}
                        {showMEPSelector && !formData.institution && (
                          <IonText>
                            <p className="institution-hint">
                              Click to select your specific institution from the MEP list
                            </p>
                          </IonText>
                        )}
                      </div>
