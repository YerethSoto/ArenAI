...
`;
    ...
    const botResponse = data.response || 
      "¡Hola Yereth! Veo que tienes una pregunta interesante sobre " + selectedSubject + ". ¿Por qué no empiezas escribiendo en tu cuaderno lo que ya sabes sobre este tema?";
