...
const BattleLobby: React.FC = () => {
  ...
  const [selectedMode, setSelectedMode] = useState<
    "standard" | "blitz" | "trick"
  >("standard");
  const [activeTab, setActiveTab] = useState<
    "shop" | "avatar" | "battle" | "clan" | "events"
  >("battle");
  ...
  const arenas = [
    {
      ...
      premise:
        "Concept: A high-tech glass observatory floating in a nebula. Deep purple and blue colors, holograms of constellations, futuristic telescopes.",
      icon: planet,
    },
    {
      id: 3,
      ...
      img: "/assets/battle_sprite_back_capybara.png",
      premise:
        "Concept: A lush, overgrown greenhouse with bioluminescent plants. Giant vines wrapping around ancient stone structures. Mystic green atmosphere.",
      icon: image,
    },
      id: 2,
      title: "Reto Lógico",
      sub: "Recompensas Dobles",
      desc: "Demuestra tu inteligencia en el modo Lógica. Preguntas nivel avanzado.",
      icon: star,
  ...
  const renderContent = () => {
    switch (activeTab) {
      case "shop":
        return (
          <div
            className="view-container slide-in"
                ...
                {avatars.map((av) => (
                  <div
                    ...
                    className={`avatar-card ${
                      selectedAvatarHero === av.id ? "selected" : ""
                    }`}
          ...
          <div className="view-container view-battle slide-in">
                ...
                <div className="friends-popover">
                  <div className="friends-header">
                    <span>
                      Amigos (
                      {
                        onlineFriends.filter((f) => f.status === "online")
                          .length
                      }
                      )
                    </span>
                    ...
                    {onlineFriends.map((friend) => (
                      <div key={friend.id} className="friend-row">
                        ...
                        <div className="f-info">
                          ...
                          <div className={`f-status ${friend.status}`}>
                            {friend.status}
                          </div>
                        </div>
                        <button
                          className="btn-vs-mini"
            ...
            <div className="lobby-arena-header">
              ...
              >
                ...
                <img
                  src={currentArena.img}
                  alt="Arena"
                  className="arena-current-img"
                />
              </div>
              ...
              <div className="lobby-battle-section">
                ...
                <button
                  className="btn-battle-gold"
                  onClick={handleBattleStart}
                  disabled={isSearching}
                >
                  <span>{isSearching ? "BUSCANDO..." : "BATALLA"}</span>
      ...
      <div className="lobby-top-bar">
        ...
        <div className="lobby-resources">
          <div className="res-item">
            <span className="res-gold">🪙</span> {user.gold}
          </div>
          <div className="res-item">
            <span className="res-gems">💎</span> {user.gems}
          </div>
        </div>
      </div>
            ...
            <div className="trophy-road-overlay">
              ...
              <div className="road-content">
                ...
                {arenas.map((arena) => (
                  <div
                    key={arena.id}
                    className={`road-arena-node ${
                      arena.id === currentArena.id ? "current" : ""
                    }`}
                  >
                    <div className="arena-concept-card">
                      ...
                      <div className="concept-body">
                        <div className="node-trophies">
                          <IonIcon icon={trophy} /> {arena.trophies}+
                        </div>
