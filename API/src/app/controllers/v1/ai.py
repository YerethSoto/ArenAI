...
from app.data.models.AskRequest import AskRequest
import ollama
router = APIRouter()
doc = {
    'name': '/ai',
...
@router.post("/ask_ollama")
def AskOllama(request: AskRequest):
    # This will be changed to a method that will parse the dict to an object later
    userinput = request.userinput
    learningType = request.learningType
    level = request.level
    name = request.name
    topics_progress = request.topics_progress
